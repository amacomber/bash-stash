...
#DownloadUrl="https://download3.vmware.com/software/fusion/file/VMware-Fusion-11.5.7-17130923.dmg"
...
Install=$(find "DMGVolume" -name "*" -depth 1)
sudo "$DMGAppInstallPath/Contents/MacOS/$Install";
