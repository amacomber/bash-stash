...
### $6 = macOS Version | Example: Ventura ####################################################
### $7 = Install macOS path | Example: Install macOS Ventura.app #############################
